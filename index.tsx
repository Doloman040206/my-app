...
const App = () => {
	...
	async function addItem(name: string, ingredients: string, price: number){
		let createResponse = await apiCratePiza(name, ingredients, price);
	...
	async function editItem(id: number, name: string, ingredients: string, price: number){
		let editResponse = await apiEditPiza(id, name, ingredients, price);
